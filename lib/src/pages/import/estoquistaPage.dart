...
class EstoquistaPage extends StatefulWidget {
  const EstoquistaPage({super.key});

  @override
  State<EstoquistaPage> createState() => _EstoquistaPageState();
}

class _EstoquistaPageState extends State<EstoquistaPage> {
