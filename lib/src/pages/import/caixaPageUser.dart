...
class CaixaPageUser extends StatefulWidget {
  const CaixaPageUser({super.key});

  @override
  State<CaixaPageUser> createState() => _CaixaPageUserState();
}

class _CaixaPageUserState extends State<CaixaPageUser> {
