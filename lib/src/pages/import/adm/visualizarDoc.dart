...
class VizualizarDoc extends StatefulWidget {
   dynamic valorTotal;
  dynamic quantidadeTotal;
  dynamic formaDePagamento;
  List<Produto> itensVendas;
   VizualizarDoc({super.key ,required this.valorTotal,required this.quantidadeTotal,required this.formaDePagamento, required this.itensVendas});

  @override
  State<VizualizarDoc> createState() => _VizualizarDocState();
}

class _VizualizarDocState extends State<VizualizarDoc> {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(backgroundColor: Colors.black87,
          ...
          title: Text("Cupom da compra"),centerTitle: true,actions: [IconButton(onPressed: (){
              Navigator.push(
                                          context,
                                          MaterialPageRoute(
